...
export default function DriverStandingsView() {
  ...
  if (loading) {
    return <div className="flex h-full w-full items-center justify-center text-slate-500 animate-pulse">Loading Live Driver Standings...</div>;
  }

  return (
    <div className="flex flex-col h-full w-full bg-[#0A0D14] p-8 overflow-y-auto custom-scrollbar">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-3xl font-black italic tracking-tighter uppercase text-white">Driver Standings</h2>
